...
//    Payment pm = new Payment();
    ...
    // 포인트 차감 결제
    public void payBonusMember(int member, LectureDTO lecture) {
...
//        int newPrice = lectureDTO.getLecPrice() - paymentDTO.getBonusPoint();
        ...
        if(newPrice < 0) {
            ...
            System.out.println(member+ "포인트 차감되었습니다.");
            System.out.println(". . .");
...
//    public int rePoint(getPrice) {
//
//        for(int i = 0; i < member.getPoint(); i++) {
//                return;
//        }
//
//
